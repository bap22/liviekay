          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px bg-[#ede4f8]">
            {services.map((s) => (
              <Link
                key={s.title}
                href={s.href}
                className="bg-white p-10 flex flex-col gap-4 group hover:bg-[#faf8fc] transition-colors"
              >
                <span className="text-3xl text-[#c8a8e9]">{s.icon}</span>
                <h3
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="flex flex-col gap-8">
            <div className="relative">
              <div className="absolute -top-4 -left-4 w-full h-full border border-[#c8a8e9] opacity-30"></div>
              <div className="bg-[#ede4f8] aspect-[4/5] flex items-center justify-center relative">
                <div className="text-center p-8">
                  <div className="text-6xl text-[#c8a8e9] mb-4">✦</div>
                  <p
                  ...
                  <p
                    className="text-xs tracking-[0.35em] uppercase text-[#c8a8e9] mt-2"
                    style={{ fontFamily: "var(--font-lato), sans-serif" }}
                  >
                    Licensed Esthetician
                  </p>
                  <div className="mt-6 border-t border-[#c8a8e9]/30 pt-6">
                    <p
                      className="text-sm text-[#777] italic"
                      style={{ fontFamily: "var(--font-cormorant), Georgia, serif" }}
                    >
                      &ldquo;Your skin is your story — let&apos;s make it beautiful.&rdquo;
                    </p>
                  </div>
                </div>
              </div>
